...
class MoveSuggestion:
    ...
    # Consider this the sort of main return value of the mechanics engine
...
def get_ranked_actions(
    ...
    *,
    ...
    # this one is actually done, it just calls search.py rank_actions with the inputs. Why we cant just forgo this entirely?
    # Might just remove later frankly. 
